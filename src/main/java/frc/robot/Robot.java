...
import frc.robot.OI;
import frc.robot.subsystems.RobotJack;
...
public class Robot extends TimedRobot {
  public static RobotJack jacksubsystem = new RobotJack();
  ...
  public void robotInit() {
    m_oi = new OI();
    // m_chooser.setDefaultCommand(new SolenoidForwardCommand());
    // m_chooser.setDefaultOption("Default Auto", new SolenoidReverse());
    // m_chooser.addOption("My Auto", new SolenoidForwardCommand());
    SmartDashboard.putData("Auto mode", m_chooser);
  }


  //public void WhenPressed(final SolenoidForwardCommand command) {
  //  WhenPressed(SolenoidForwardCommand);
  //}
